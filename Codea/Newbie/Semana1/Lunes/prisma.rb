def prism_type(l1,l2,l3)                        #Se define el metodo con 3 parametros
    tipo='x'                                    #Se crea una variable para el metodo
  if l1!=l2 && l2!=l3 && l1!=l3                 #se hace una condicion si los 3 parametros son diferentes
      tipo="cuboide"                            #se imprime cuboide
    elsif l1==l2 && l1!=l3                      #se crea otra condicion si 2 lados son iguales y el otro lado es diferente de
      tipo="prisma rectangular"                 #se imprime prisma rectangular 
      elsif l1==l2 && l1==l3                    #se crea otra condicion si 2 lados son iguales y el otro tambien es igual
